...
const translations = {
  id: {
    ...
    // Home Page
    'home.hero.title': 'Kopi & Rempah',
    'home.hero.subtitle': 'Nusantara',
    'home.hero.description': 'Menghadirkan citarasa otentik Indonesia dengan kualitas premium langsung dari petani terpilih ke meja Anda',
    'home.hero.viewProducts': 'Lihat Produk',
    'home.hero.contactUs': 'Hubungi Kami',

    'home.about.title': 'Tentang Kopi Nusantara',
    'home.about.description': 'Sejak 2018, kami berkomitmen menjadi jembatan antara petani lokal dan pecinta kopi serta rempah-rempah. Dengan proses seleksi ketat dan standar kualitas internasional, setiap produk kami menghadirkan kekayaan rasa dan aroma Indonesia yang autentik.',

    'home.whyUs.title': 'Mengapa Memilih Kami?',
    'home.whyUs.quality.title': 'Kualitas Premium',
    'home.whyUs.quality.desc': 'Seleksi ketat dari petani terpilih dengan standar kualitas internasional',
    'home.whyUs.natural.title': '100% Natural',
    'home.whyUs.natural.desc': 'Tanpa bahan pengawet atau pewarna buatan, murni dari alam',
    'home.whyUs.trusted.title': 'Dipercaya Ribuan',
    'home.whyUs.trusted.desc': 'Dipercaya lebih dari 5000+ pelanggan di seluruh Indonesia',
    'home.whyUs.guarantee.title': 'Garansi Kualitas',
    'home.whyUs.guarantee.desc': 'Jaminan 100% uang kembali jika tidak puas dengan kualitas',
    ...
    'home.gallery.description': 'Lihat koleksi lengkap produk dan proses produksi kami',
  ...
  en: {
    ...
    'home.hero.description': 'Bringing authentic Indonesian flavors with premium quality directly from selected farmers to your table',
    'home.hero.viewProducts': 'View Products',
    'home.hero.contactUs': 'Contact Us',

    'home.about.title': 'About Kopi Nusantara',
    'home.about.description': 'Since 2018, we are committed to being a bridge between local farmers and coffee and spice lovers. With strict selection processes and international quality standards, each of our products brings the authentic richness of Indonesian taste and aroma.',

    'home.whyUs.title': 'Why Choose Us?',
    'home.whyUs.quality.title': 'Premium Quality',
    'home.whyUs.quality.desc': 'Strict selection from trusted farmers with international quality standards',
    'home.whyUs.natural.title': '100% Natural',
    'home.whyUs.natural.desc': 'No artificial preservatives or colorings, purely from nature',
    'home.whyUs.trusted.title': 'Trusted by Thousands',
    'home.whyUs.trusted.desc': 'Trusted by more than 5000+ customers throughout Indonesia',
    'home.whyUs.guarantee.title': 'Quality Guarantee',
    'home.whyUs.guarantee.desc': '100% money back guarantee if not satisfied with quality',
    ...
    'home.gallery.description': 'See our complete product collection and production process',
  ...
  fr: {
    ...
    'home.hero.description': 'Apporter des saveurs indonésiennes authentiques avec une qualité premium directement des agriculteurs sélectionnés à votre table',
    'home.hero.viewProducts': 'Voir les Produits',
    'home.hero.contactUs': 'Nous Contacter',

    'home.about.title': 'À Propos de Kopi Nusantara',
    'home.about.description': 'Depuis 2018, nous nous engageons à être un pont entre les agriculteurs locaux et les amateurs de café et d\'épices. Avec des processus de sélection stricts et des normes de qualité internationales, chacun de nos produits apporte la richesse authentique du goût et de l\'arôme indonésiens.',

    'home.whyUs.title': 'Pourquoi Nous Choisir?',
    'home.whyUs.quality.title': 'Qualité Premium',
    'home.whyUs.quality.desc': 'Sélection stricte d\'agriculteurs de confiance avec des normes de qualité internationales',
    'home.whyUs.natural.title': '100% Naturel',
    'home.whyUs.natural.desc': 'Aucun conservateur ou colorant artificiel, purement naturel',
    'home.whyUs.trusted.title': 'Approuvé par des Milliers',
    'home.whyUs.trusted.desc': 'Approuvé par plus de 5000+ clients dans toute l\'Indonésie',
    'home.whyUs.guarantee.title': 'Garantie Qualité',
    'home.whyUs.guarantee.desc': 'Garantie de remboursement à 100% si pas satisfait de la qualité',
    ...
    'home.gallery.description': 'Découvrez notre collection complète de produits et notre processus de production',
  ...
  ar: {
    ...
    'home.hero.description': 'نقدم النكهات الإندونيسية الأصيلة بجودة ممتازة مباشرة من المزارعين المختارين إلى طاولتك',
    'home.hero.viewProducts': 'عرض المنتجات',
    'home.hero.contactUs': 'اتصل بنا',

    'home.about.title': 'حول كوبي نوسانتارا',
    'home.about.description': 'منذ عام 2018، نحن ملتزمون بأن نكون جسراً بين المزارعين المحليين وعشاق القهوة والتوابل. مع عمليات الاختيار الصارمة ومعايير الجودة الدولية، كل منتج من منتجاتنا يجلب الثراء الأصيل للطعم والرائحة الإندونيسية.',

    'home.whyUs.title': 'لماذا تختارنا؟',
    'home.whyUs.quality.title': 'جودة ممتازة',
    'home.whyUs.quality.desc': 'اختيار صارم من المزارعين الموثوقين بمعايير جودة دولية',
    ...
    'home.whyUs.trusted.desc': 'موثوق من أكثر من 5000+ عميل في جميع أنحاء إندونيسيا',
    'home.whyUs.guarantee.title': 'ضمان الجودة',
    'home.whyUs.guarantee.desc': 'ضمان استرداد المال 100% إذا لم تكن راضياً عن الجودة',
    ...
    'home.gallery.description': 'شاهد مجموعتنا الكاملة من المنتجات وعملية الإنتاج',
