...
import { MessageCircle, ShoppingCart, CheckCircle, Phone, ArrowRight } from 'lucide-react';
  ...
  const orderSteps = [
    {
      ...
      icon: ShoppingCart,
      title: 'Pilih Produk', 
      description: 'Jelajahi koleksi kopi dan rempah-rempah premium kami. Klik "Detail Produk" untuk informasi lengkap.',
      details: [
    ...
    },
    {
      ...
      description: 'Kontak melalui WhatsApp, form online, atau telepon untuk konsultasi dan pemesanan.',
      details: [
    ...
    },
    {
      ...
      description: 'Tim kami akan mengkonfirmasi pesanan dan memandu proses pembayaran yang mudah.',
      details: [
  ...
  const productGallery = [
    {
      ...
      description: 'Kopi robusta pilihan dengan citarasa kuat dan aroma menggugah selera'
    },
    {
      id: 2,
      name: 'Kopi Arabika Gayo',
      image: 'https://images.pexels.com/photos/1793037/pexels-photo-1793037.jpeg',
      description: 'Kopi arabika asli Aceh dengan karakteristik fruity dan floral'
    },
    {
      id: 3,
      ...
      <section className="bg-white py-20">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed">
            Proses pemesanan yang mudah dan transparan. Ikuti 3 langkah sederhana 
            untuk mendapatkan kopi dan rempah-rempah premium kami.
          </p>
        </div>
      </section>
              ...
              <div key={step.step} className={`flex flex-col lg:flex-row items-center gap-12 ${
                ...
                <div className="flex-1">
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold text-amber-800">{step.title}</h3>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            <div className="bg-white rounded-2xl shadow-md p-8">
              <h3 className="text-xl font-bold text-amber-800 mb-4">Berapa minimal order?</h3>
              <p className="text-gray-700">
                Tidak ada minimal order. Anda bisa memesan mulai dari 1 pack untuk mencoba kualitas produk kami.
              </p>
            </div>
            
            <div className="bg-white rounded-2xl shadow-md p-8">
              <h3 className="text-xl font-bold text-amber-800 mb-4">Bagaimana cara pembayaran?</h3>
              <p className="text-gray-700">
                Kami menerima pembayaran via transfer bank, e-wallet (GoPay, OVO, DANA), dan COD untuk area Yogyakarta.
              </p>
            </div>
            
            <div className="bg-white rounded-2xl shadow-md p-8">
              <h3 className="text-xl font-bold text-amber-800 mb-4">Bagaimana jika produk tidak sesuai?</h3>
              <p className="text-gray-700">
                Kami memberikan garansi 100% uang kembali jika produk tidak sesuai atau rusak saat diterima.
              </p>
            </div>
            
            <div className="bg-white rounded-2xl shadow-md p-8">
              <h3 className="text-xl font-bold text-amber-800 mb-4">Berapa lama pengiriman?</h3>
              <p className="text-gray-700">
                Estimasi pengiriman 2-5 hari kerja tergantung lokasi. Untuk Yogyakarta bisa same day delivery.
              </p>
            </div>
          </div>
        </div>
