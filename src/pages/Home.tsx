...
import { ArrowRight, CheckCircle, Award, Leaf, Users, ChevronLeft, ChevronRight, User } from 'lucide-react';
...
const Home = () => {
  ...
  const teamMembers = [
    {
      ...
      avatar: '👨‍💼',
      description: 'Memimpin visi perusahaan dengan pengalaman 15+ tahun di industri kopi'
    },
    {
      name: t('home.team.manager.name'),
      role: t('home.team.manager.role'),
      avatar: '👩‍🔬',
      description: 'Mengawasi seluruh proses produksi dengan standar kualitas tertinggi'
    },
    {
      name: t('home.team.expert.name'),
      role: t('home.team.expert.role'),
      avatar: '👨‍🌾',
      description: 'Ahli dalam seleksi dan grading kopi serta rempah-rempah premium'
    }
  ];
  ...
  const bestProducts = [
    ...
    },
    {
      ...
      description: 'Kayu manis Ceylon grade A dengan aroma manis alami dan kualitas export',
      image: 'https://images.pexels.com/photos/894695/pexels-photo-894695.jpeg'
    },
    {
      id: 3,
      name: 'Lada Hitam Muntok',
      description: 'Lada hitam asli Bangka dengan tingkat kepedasan sempurna untuk masakan',
      image: 'https://images.pexels.com/photos/4198019/pexels-photo-4198019.jpeg'
    },
    {
      id: 4,
      name: 'Pala Banda',
      description: 'Pala asli Banda dengan aroma khas dan rasa yang autentik untuk bumbu masakan',
        ...
        <div className="absolute inset-0 z-10 max-w-7xl mx-auto px-4 h-full flex items-center">
          <div className="max-w-2xl text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              >
                {t('home.hero.viewProducts')} <ArrowRight className="ml-2 h-5 w-5" />
              </Link>
              <Link
                to="/contact"
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center group">
              ...
              <h3 className="font-semibold text-xl text-amber-800 mb-4">{t('home.whyUs.quality.title')}</h3>
            ...
            <div className="text-center group">
              ...
              <h3 className="font-semibold text-xl text-amber-800 mb-4">{t('home.whyUs.natural.title')}</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="text-center group">
              ...
              <h3 className="font-semibold text-xl text-amber-800 mb-4">{t('home.whyUs.trusted.title')}</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="text-center group">
              ...
              <h3 className="font-semibold text-xl text-amber-800 mb-4">{t('home.whyUs.guarantee.title')}</h3>
              <p className="text-gray-600 leading-relaxed">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
            ...
            {bestProducts.map((product) => (
              <div key={product.id} className="bg-white rounded-2xl shadow-lg overflow-hidden group hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                ...
                <div className="p-6">
                  ...
                  >
                    {t('home.products.detail')} <ArrowRight className="ml-2 h-4 w-4" />
                  </Link>
                </div>
              </div>
            ))}
          ...
          <div className="text-center mt-12">
            ...
            >
              {t('home.products.viewAll')} <ArrowRight className="ml-2 h-5 w-5" />
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="relative max-w-5xl mx-auto">
            <div className="relative h-80 rounded-2xl overflow-hidden">
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent p-6">
                <h3 className="text-white text-xl font-semibold">{galleryVideos[currentGallerySlide].title}</h3>
                {galleryVideos[currentGallerySlide].type === 'video' && (
                  <span className="text-white text-sm opacity-75">🎥 Video</span>
                )}
              </div>
            </div>
            
            <button
              onClick={() => setCurrentGallerySlide((prev) => (prev - 1 + galleryVideos.length) % galleryVideos.length)}
            ...
            <button
              onClick={() => setCurrentGallerySlide((prev) => (prev + 1) % galleryVideos.length)}
              ...
              {galleryVideos.map((_, index) => (
                <button
                  ...
                  className={`w-3 h-3 rounded-full transition-all duration-200 ${
                    index === currentGallerySlide ? 'bg-amber-600' : 'bg-gray-300'
                  }`}
                />
              ))}
            </div>
          ...
          <div className="text-center mt-12">
            ...
            >
              {t('home.gallery.viewGallery')} <ArrowRight className="ml-2 h-5 w-5" />
            </Link>
          </div>
        </div>
      </section>
            ...
            {teamMembers.map((member, index) => (
              <div key={index} className="text-center group">
                <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                  ...
                  <h3 className="font-semibold text-xl text-amber-800 mb-2">{member.name}</h3>
